        ...
        items.forEach(item => {
          ...
          card.innerHTML = `
            <div class="cert-image">
              ${imgSrc ? `<a href="${escapeAttr(pdf || imgSrc || verify || imgSrc)}" target="_blank" rel="noopener"><img src="${escapeAttr(imgSrc)}" alt="${escapeAttr(title)} certificate" loading="lazy"/></a>` : ''}
            </div>
            <div class="cert-body">
              ...
              <div class="cert-actions">
                ${(pdf || imgSrc || verify) ? `<a href="${escapeAttr(pdf || imgSrc || verify)}" class="btn" target="_blank" rel="noopener">View Certification</a>` : ''}
              </div>
            </div>
          `;
